...
API_ID = int(getenv("API_ID", 24569721))
API_HASH = getenv("API_HASH", "b0081b01a3f015d9c76f5ed9e7b20271")
BOT_TOKEN = getenv("BOT_TOKEN", None)
OWNER_ID = int(getenv("OWNER_ID", 7853121219))
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://Akash:Akash@akash.cbqfo1w.mongodb.net/?retryWrites=true&w=majority&appName=Akash")
SUPPORT_GRP = getenv("SUPPORT_GRP", "AnanyaBotSupport")
UPDATE_CHNL = getenv("UPDATE_CHNL", "AnanyaBots")
OWNER_USERNAME = getenv("OWNER_USERNAME", "WTF_NoHope")
