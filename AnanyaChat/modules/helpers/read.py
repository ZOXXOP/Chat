...
START = f"""
<b>👋 ʜᴇʏ! ɪ'ᴍ [{AnanyaBot.name}](t.me/{AnanyaBot.username})</b>  
...
SOURCE_READ = f"""
💻 <b>sᴏᴜʀᴄᴇ ᴏғ [{AnanyaBot.name}](https://t.me/{AnanyaBot.username})</b>  

<b>🌟 ғᴏʀᴋ & sᴛᴀʀ → [GitHub Repo](https://github.com/ZOXXOP/AnanyaChat)</b>  
...
ABOUT_READ = f"""
ℹ️ <u><b>ᴀʙᴏᴜᴛ {AnanyaBot.name}</b></u>  
